...
let tempCatalog = [...this.state.movies]
tempCatalog.find(m=>m.id === movieId).isRented = true
this.setState ({ movies: tempCatalog})
  }
      ...
      <Router>
        <div className='App'>
          ...
          render={() => <Catalog
                          ...
                          rentTheMovie={this.rentTheMovie} 
                          removeFromRented={this.removeFromRented}
                        />}
          />
          <Route
          exact
          path='/catalog/movie/:title'
